...
study_end_date   <- "2025-03-31"   ## overall database end, not the cohort's initiation window end -
                                     ## follow-up can extend past 2013-12-31 for patients who initiate late in the window
followup_window_years <- 22         ## covers index dates from 2004 through to the 2025-03-31 study end
