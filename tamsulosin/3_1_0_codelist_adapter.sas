...
data codelist.chronic_liver;
	...
	length MedCode $19 Observations 8 OriginalReadCode $7 Term $102 CleansedReadCode $7 SnomedCTConceptId 8 SnomedCTDescriptionId 8 EmisCodeCategoryId 8;
	input MedCode $19. Observations OriginalReadCode $7. Term $102. CleansedReadCode $7. SnomedCTConceptId SnomedCTDescriptionId EmisCodeCategoryId;
run;
